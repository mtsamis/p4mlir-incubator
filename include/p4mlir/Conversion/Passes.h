...
#define GEN_PASS_DECL_LOWERP4HIRTOMLIRCORE
#include "p4mlir/Conversion/Passes.h.inc"

std::unique_ptr<mlir::Pass> createLowerP4HIRToMLIRCorePass();
...
void populateP4HIRToMLIRCoreConversionPatterns(mlir::TypeConverter &converter,
                                               mlir::RewritePatternSet &patterns);
