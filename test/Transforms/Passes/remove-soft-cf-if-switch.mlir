...
module {
  ...
  p4hir.func @f1(%arg0: !p4hir.ref<!b8i>) {
    ...
    %eq = p4hir.cmp(eq, %val_0, %c100_b8i) : !b8i, !p4hir.bool
    p4hir.if %eq {
      p4hir.soft_return
    }
  ...
  p4hir.overload_set @f2 {
    ...
    p4hir.func @f2_0(%arg0: !p4hir.ref<!b8i>) {
      ...
      %val_1 = p4hir.read %arg0 : <!b8i>
      %eq_2 = p4hir.cmp(eq, %val_1, %c-56_b8i) : !b8i, !p4hir.bool
      p4hir.if %eq_2 {
        p4hir.soft_return
      }
    ...
    p4hir.func @f2_1(%arg0: !p4hir.ref<!b8i>) -> !b8i {
      ...
      %c100_b8i = p4hir.const #int100_b8i
      %val = p4hir.read %arg0 : <!b8i>
      %gt = p4hir.cmp(gt, %val, %c100_b8i) : !b8i, !p4hir.bool
      p4hir.if %gt {
  ...
  p4hir.func @f3(%arg0: !p4hir.ref<!b8i>) -> !b8i {
    ...
    %c100_b8i = p4hir.const #int100_b8i
    %val = p4hir.read %arg0 : <!b8i>
    %lt = p4hir.cmp(lt, %val, %c100_b8i) : !b8i, !p4hir.bool
    p4hir.if %lt {
    } else {
      %val_1 = p4hir.read %arg0 : <!b8i>
      %eq = p4hir.cmp(eq, %val_1, %c-56_b8i) : !b8i, !p4hir.bool
      p4hir.if %eq {
  ...
  p4hir.func @f6(%arg0: !p4hir.ref<!b8i>) -> !b8i {
    ...
    %c100_b8i = p4hir.const #int100_b8i
    %val = p4hir.read %arg0 : <!b8i>
    %ne = p4hir.cmp(ne, %val, %c100_b8i) : !b8i, !p4hir.bool
    // CHECK: p4hir.if
    // CHECK-NOT: %c10_b8i
    // CHECK-NOT: %c20_b8i
    // CHECK: p4hir.return
  ...
  p4hir.func @f7(%arg0: !p4hir.ref<!b8i>) -> !b8i {
    ...
    p4hir.switch (%val : !b8i) {
      ...
      p4hir.case(equal, [#int2_b8i]) {
        ...
        %gt = p4hir.cmp(gt, %val_2, %c100_b8i) : !b8i, !p4hir.bool
        p4hir.if %gt {
          %val_3 = p4hir.read %arg0 : <!b8i>
    ...
    %val_0 = p4hir.read %arg0 : <!b8i>
    %lt = p4hir.cmp(lt, %val_0, %c10_b8i) : !b8i, !p4hir.bool
    p4hir.if %lt {
      %val_2 = p4hir.read %arg0 : <!b8i>
