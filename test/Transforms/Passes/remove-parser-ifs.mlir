// RUN: p4mlir-opt --p4hir-remove-parser-ifs --canonicalize %s | FileCheck %s
...
module {
  ...
  p4hir.parser @p1(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
  ...
  p4hir.parser @p2(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    %c2_b8i = p4hir.const #int2_b8i
    // CHECK: p4hir.state @start_pre {
    // CHECK:   %eq = p4hir.cmp(eq, %arg0, %c2_b8i) : !b8i, !p4hir.bool
    // CHECK:   p4hir.transition_select %eq : !p4hir.bool {
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %true : !p4hir.bool
    // CHECK:     } to @p2::@start_then
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %false : !p4hir.bool
    // CHECK:     } to @p2::@start_else
    // CHECK:   }
    // CHECK: }
    // CHECK: p4hir.state @start_then {
  ...
  p4hir.parser @p3(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    %c2_b8i = p4hir.const #int2_b8i
    %c1_b8i = p4hir.const #int1_b8i
    p4hir.state @start {
      %eq = p4hir.cmp(eq, %arg0, %c2_b8i) : !b8i, !p4hir.bool
    ...
    // CHECK: p4hir.state @start_then {
    // CHECK:   p4hir.assign %c1_b8i, %arg1 : <!b8i>
    // CHECK:   p4hir.transition to @p3::@start_post
    // CHECK: }
    // CHECK: p4hir.state @start_else {
    // CHECK:   p4hir.assign %c2_b8i, %arg1 : <!b8i>
    // CHECK:   p4hir.transition to @p3::@start_post
  ...
  p4hir.parser @p4(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    ...
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %true : !p4hir.bool
    // CHECK:     } to @p4::@start_then
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %false : !p4hir.bool
    // CHECK:     } to @p4::@start_else
    // CHECK:   }
    // CHECK: }
    // CHECK: p4hir.state @start_then {
    // CHECK:   p4hir.transition to @p4::@start_then_pre
    // CHECK: }
    // CHECK: p4hir.state @start_then_pre {
    // CHECK:   %eq = p4hir.cmp(eq, %arg0, %c10_b8i) : !b8i, !p4hir.bool
    // CHECK:   p4hir.transition_select %eq : !p4hir.bool {
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %true : !p4hir.bool
    // CHECK:     } to @p4::@start_then_then
    // CHECK:     p4hir.select_case {
    // CHECK:       p4hir.yield %false : !p4hir.bool
    // CHECK:     } to @p4::@start_then_else
    // CHECK:   }
    // CHECK: }
    // CHECK: p4hir.state @start_then_then {
    // CHECK:   p4hir.assign %c1_b8i, %arg1 : <!b8i>
    // CHECK:   p4hir.transition to @p4::@start_then_post
    // CHECK: }
    // CHECK: p4hir.state @start_then_else {
    // CHECK:   p4hir.assign %c2_b8i, %arg1 : <!b8i>
    // CHECK:   p4hir.transition to @p4::@start_then_post
    // CHECK: }
    // CHECK: p4hir.state @start_then_post {
    // CHECK:   p4hir.transition to @p4::@start_post
    // CHECK: }
    // CHECK: p4hir.state @start_else {
  ...
  p4hir.parser @p5(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    %c10_b8i = p4hir.const #int10_b8i
    %c2_b8i = p4hir.const #int2_b8i
    %c3_b8i = p4hir.const #int3_b8i
    %c1_b8i = p4hir.const #int1_b8i
